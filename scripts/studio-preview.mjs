      ...
      tasks: [
        {
          ...
          smartEditProposal: { version: 2, id: 'a'.repeat(64), state: 'PROPOSED', requiresConfirmation: true,
            message: 'Посмотрел расшифровку и AI-анализ. Предлагаю быстрее перейти к сути и сделать темп плотнее. Пока ничего не сокращал.',
            beforeSeconds: 105.2, afterSeconds: 93.6,
            changes: [{ intent: 'SOURCE_START_SET_USER', value: '5.2', title: 'Начать с 5,2 секунды', reason: 'Здесь начинается конкретная история — зритель сразу понимает, о чём ролик.' },
              { intent: 'REMOVE_ALL_PAUSES', value: '', title: 'Убрать длинные паузы', reason: 'Уберу 5,4 секунды тишины, сохранив запас вокруг слов.' },
              { intent: 'REMOVE_SPEECH_RETAKES', value: '', title: 'Убрать случайные повторы речи', reason: 'Оставить последнюю попытку произнести фразу.',
                cuts: [{ id: 'repeat-8-10-11', sourceStart: 12.46, sourceEnd: 13.46, removedText: 'я я', keptText: 'я', reason: 'Повторная попытка начать предложение; смысл сохранится.' }] }] },
          updatedAt: '2026-09-22T08:42:00.000Z',
